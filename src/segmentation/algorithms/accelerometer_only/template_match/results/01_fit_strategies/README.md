...
- `fit_strategy_A_active_mask_uriya.png`
- `fit_strategy_B_aic_uriya.png`
- `fit_strategy_C_triangle_vs_par_uriya.png`
- `fit_strategy_D_normalized_shape_uriya.png`
- `fit_strategy_E_plateau_gate_uriya.png`
- `fit_strategy_F_bounded_p_uriya.png`

Each PNG shows the 44 uriya rides as a grid; black = trapezoid fit, purple dashed = parabola fit, yellow = GT window. The annotation box reports the scoring-strategy winner per ride and its parameters.
