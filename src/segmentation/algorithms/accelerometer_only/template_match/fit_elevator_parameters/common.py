...
# The pure fit primitives moved into the package with the detector; the
# research fitters keep reading them from this module, so re-export.
from pyramidElevatorDist.segmentation.algorithms.accelerometer_only.template_match.fit_elevator_parameters.common import (  # noqa: E402, E501, F401
    _DETREND_SEC,
    _a_mag_minus_g,
    _estimate_fs_hz,
    _smooth,
