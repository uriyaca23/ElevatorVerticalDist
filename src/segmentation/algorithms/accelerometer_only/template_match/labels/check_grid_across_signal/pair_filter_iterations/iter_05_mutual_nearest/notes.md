# Iteration: 05_mutual_nearest

**What changed:** Mutual nearest neighbour: only pair + with − (or vice versa) if each is the other's nearest admissible opposite. Structural attack on lobe-jumping.

**Variant kwargs:** `{'require_mutual_nearest': True}`
