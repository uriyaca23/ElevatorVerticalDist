...
def main() -> None:
    ...
    # Calibration is auto-loaded from the algorithm's committed
    # calibration.json when the Predictor is constructed.
    p = Predictor(PREDICT_ALGORITHM_CONFIG(algorithm=PredictAlgorithm.TRAPEZOID_ACCEL))
    print("[calib] using the algorithm's committed calibration.json")
